...
import com.blog.rest.errors.EmailAlreadyUsedException;
import com.blog.rest.errors.InvalidPasswordException;
import com.blog.rets.errors.LoginAlreadyUsedException;
import com.blog.security.AuthoritiesConstants;
import com.blog.security.SecurityUtils;
import com.blog.util.RandomUtil;
...
//                user.setLangKey(userDTO.getLangKey());
    ...
    public Page<UserDTO> getAllManagedUsers(Pageable pageable) {
        return userRepository.findAllByLoginNot(pageable, BlogConstants.ANONYMOUS_USER).map(UserDTO::new);
    }
